 ...
 * @since     0.7.0
 */
  define( 'WPDTRT_ANCHORLINKS_VERSION', '0.0.1' );
}
 ...
 */
  ...
  require_once(WPDTRT_ANCHORLINKS_PATH . 'vendor/dotherightthing/wpdtrt-plugin/index.php');
    ...
    $wpdtrt_anchorlinks_plugin = new WPDTRT_Anchorlinks_Plugin(
      array(
        ...
        'messages' => array(
          ...
          'noscript_warning' => __('JavaScript is disabled. Please enable JavaScript to load demo data.', 'wpdtrt-anchorlinks'),
